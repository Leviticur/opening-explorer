...
def opening_explorer(jsdata):
    ...
    elif jsdata.startswith("setexcludedopponent"):
        excluded_opponents.append(jsdata[19:])
    elif jsdata == "resetopponents":
        opponent = None
        excluded_opponents = list()
    ...
    games = explorer_functions.get_games(white, username, game_data, moves, time_control, opponent, excluded_opponents)
